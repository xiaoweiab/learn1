...
def count_profit(json_content):
    ...
    # profit_dict = dict()
    # profit_dict.__setitem__('2013-06-30', 0)
    # profit_dict.__setitem__('2013-12-31', 0)
    # profit_dict.__setitem__('2014-06-30', 0)
    # profit_dict.__setitem__('2014-12-31', 0)
    # profit_dict.__setitem__('2015-06-30', 0)
    # profit_dict.__setitem__('2015-12-31', 0)
    # profit_dict.__setitem__('2016-06-30', 0)
    # profit_dict.__setitem__('2016-12-31', 0)
...
if __name__ == '__main__':
    ...
    path = 'C:\\Users\\Hasee\\Desktop\\新三板整理数据\\task1_final_01.txt'
    ...
    for i, file_name in enumerate(os.listdir(base_path)):
        ...
        print(avg_profit)
        if avg_profit:
           result =  main(json_content) +'{:.2f}'.format(avg_profit)+'\n'
           # print(result)
